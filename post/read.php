<?php
	include $_SERVER['DOCUMENT_ROOT']."/POST/db.php"; /* db load */
?>
<!doctype html>
<head>
<meta charset="UTF-8">
...
<link rel="stylesheet" type="text/css" herf="/POST/css/jquery-ui.css" />
<script type="text/javascript" src="/POST/js/jquery-3.2.1.min.js"></script>
<script type="text/javascript" src="/POST/js/jquery-ui.js"></script>
<script type="text/javascript" src="/POST/js/common.js"></script>
</head>
<body>
	<?php
...
<div id="board_read">
	<h2><?php echo $board['title']; ?></h2>
		<div id="user_info">
			...
			<div>
				파일 : <a herf="upload/<?php echo $board['file'];?>" download><?php echo $board['file']; ?></a>
			<div id="bo_content">
...
<div class="reply_view">
	<h3>댓글목록</h3>
		...
		<div class="dap_lo">
			...
			<!-- 댓글 수정 폼 dialog -->
			<div class="dat_edit">
				<form method="post" action="/POST/rep_modify_ok.php">
			...
			<div class='dat_delete'>
				<form action="/POST/reply_delete.php" method="post">
					<input type="hidden" name="rno" value="<?php echo $reply['idx']; ?>" /><input type="hidden" name="b_no" value="<?php echo $bno; ?>">
	...
	<!--- 댓글 입력 폼 -->
	<div class="dap_ins">
		<form action="/POST/reply_ok.php?idx=<?php echo $bno; ?>" method="post">
